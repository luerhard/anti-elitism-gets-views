  ...
  python311 = prev.python311.override {
    packageOverrides = pyfinal: pyprev: {
      ...
      yt-dlp = pyprev.buildPythonPackage rec {
        ...
        propagatedBuildInputs = [
          prev.python311.pkgs.brotli
          prev.python311.pkgs.certifi
          prev.python311.pkgs.mutagen
          prev.python311.pkgs.pycryptodomex
          prev.python311.pkgs.requests
          prev.python311.pkgs.urllib3
          prev.python311.pkgs.websockets
        ];
      };
